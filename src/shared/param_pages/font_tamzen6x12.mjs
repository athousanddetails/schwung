...
const G = [
    ...
    [6, 0, 3, 7, 4, 4, 4, 4, 0, 0, 4],  /* ! */
    [6, 0, 4, 7, 10, 10, 0, 0, 0, 0, 0],  /* " */
    [6, 0, 3, 7, 4, 4, 0, 0, 0, 0, 0],  /* ' */
    [6, 0, 3, 7, 4, 4, 2, 2, 2, 2, 4],  /* ( */
    [6, 0, 4, 7, 4, 4, 8, 8, 8, 8, 4],  /* ) */
    [6, 0, 5, 7, 0, 4, 4, 31, 4, 4, 0],  /* + */
    [6, 0, 3, 7, 0, 0, 0, 0, 0, 6, 6],  /* , */
    [6, 0, 5, 7, 0, 0, 0, 31, 0, 0, 0],  /* - */
    [6, 0, 3, 7, 0, 0, 0, 0, 0, 6, 6],  /* . */
    [6, 0, 4, 7, 8, 8, 4, 4, 2, 2, 1],  /* / */
    ...
    [6, 0, 5, 7, 5, 21, 10, 4, 10, 21, 20],  /* % */
    [6, 0, 5, 7, 16, 8, 4, 2, 4, 8, 16],  /* < */
    [6, 0, 4, 7, 1, 2, 4, 8, 4, 2, 1],  /* > */
    [6, 0, 5, 7, 0, 0, 31, 0, 31, 0, 0],  /* = */
    [6, 0, 5, 7, 17, 16, 8, 4, 0, 0, 4],  /* ? */
    [6, 0, 5, 7, 0, 4, 21, 14, 21, 4, 0],  /* * */
    [6, 0, 5, 7, 10, 31, 10, 10, 31, 10, 10],  /* # */
    [6, 0, 5, 7, 5, 5, 2, 21, 9, 9, 22],  /* & */
    [6, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0],  /* _ */
    [6, 0, 4, 7, 1, 1, 2, 2, 4, 4, 8],  /* \\ */
