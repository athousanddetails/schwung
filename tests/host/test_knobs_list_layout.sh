...
expected="MENU_BRACKET_LEN MENU_FRAME_BOTTOM_INSET MENU_FRAME_W MENU_FRAME_X MENU_FRAME_Y MENU_LIST_INDICATOR_X TRIGGER_BURST_KEEP_MS TRIGGER_BURST_MAX TRIGGER_KNOB_COOLDOWN_MS "
